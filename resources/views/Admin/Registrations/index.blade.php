...
<div class="reg-layout">
    ...
    <div class="reg-list">
        ...
        @forelse ($pending as $applicant)
            <a href="{{ route('admin.registrations.index', ['view' => $applicant->id]) }}"
               class="reg-list__item {{ $selected && $selected->id === $applicant->id ? 'is-active' : '' }}">
                ...
                <div class="reg-list__info">
                    ...
                    <span class="reg-list__role">Buyer &middot; {{ $applicant->created_at->diffForHumans() }}</span>
                </div>
    ...
    <div class="reg-detail">
        @if ($selected)
            ...
            <div class="reg-detail__actions">
                <form method="POST" action="{{ route('admin.registrations.approve', $selected) }}">
                    @csrf
            ...
            <div id="rejectPanel" class="reg-reject-panel" hidden>
                <form method="POST" action="{{ route('admin.registrations.reject', $selected) }}">
                    @csrf
